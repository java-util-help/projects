	...
	public void updateMessage() {
		...
		if(!selectedSeats.isEmpty()) {
			for(int counter : selectedSeats) {
				if(counter < 12)
					message = message + " A" + (counter+1);
				else if(counter <24)
					message = message + " B" + (counter+1-12);
				else if(counter <36)
					message = message + " C" + (counter+1-24);
				else if(counter <48)
					message = message + " D" + (counter+1-36);
				else if(counter <60)
					message = message + " E" + (counter+1-48);
			}
            ...
            .addGroup(seatsPanelLayout.createSequentialGroup()
                ...
                .addGroup(seatsPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(seatsPanelLayout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addGroup(seatsPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
